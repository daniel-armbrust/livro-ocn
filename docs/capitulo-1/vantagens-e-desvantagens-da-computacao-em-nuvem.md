...
!!! note "NOTA"
    Consulte <a href="https://blogs.oracle.com/ateam/post/why-infrastructure-as-code-matters" target="_blank"><i>"Why Infrastructure as Code Matters"</i></a> para uma visão dos benefícios de utilizar ferramentas de IaC.
